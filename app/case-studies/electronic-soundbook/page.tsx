...
export default function ElectronicSoundbookPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section style={{ background: 'var(--card)', padding: '60px 24px', marginTop: '80px', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <p style={{ color: 'var(--muted-foreground)', fontSize: '12px', fontWeight: 600, letterSpacing: '1px', marginBottom: '12px', textTransform: 'uppercase' }}>PRODUCT DEVELOPMENT JOURNEY</p>
          <h1 style={{ fontSize: '48px', fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', color: 'var(--foreground)', lineHeight: 1.2, marginBottom: '20px' }}>
            Electronic Soundbook: From Brief to Shelf
          </h1>
          <p style={{ fontSize: '16px', color: 'var(--muted-foreground)', marginBottom: '20px', lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div>
              <span style={{ fontSize: '11px', color: 'var(--muted-foreground)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px', display: 'block', marginBottom: '4px' }}>Role</span>
              <span style={{ fontSize: '14px', fontWeight: 500, color: 'var(--foreground)' }}>Product Lead | Physical Product | EdTech | B2C | Early Childhood Learning</span>
            </div>
            <div>
              <span style={{ fontSize: '11px', color: 'var(--muted-foreground)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px', display: 'block', marginBottom: '4px' }}>Key Metrics</span>
              <span style={{ fontSize: '14px', fontWeight: 500, color: 'var(--foreground)' }}>$7 COGS | $25 Retail | 85% PSR | 5 Markets (US, EU, UK, GCC, India)</span>
            </div>
          </div>
      ...
      {/* Case Study Content */}
      <section style={{ padding: '60px 24px', background: 'var(--background)' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', fontSize: '16px', lineHeight: 1.7, color: 'var(--foreground)' }}>
          
          <h2 style={{ fontSize: '28px', fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', marginTop: '40px', marginBottom: '20px', color: 'var(--foreground)' }}>The Starting Point</h2>
          ...
          <h2 style={{ fontSize: '28px', fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', marginTop: '40px', marginBottom: '20px', color: 'var(--foreground)' }}>Understanding the Problem Before Building the Product</h2>
