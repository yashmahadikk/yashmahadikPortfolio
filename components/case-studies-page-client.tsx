  ...
  return (
    <>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <button
                ...
                className="bg-indigo-50 dark:bg-indigo-950/20 group p-8 rounded-lg h-full flex flex-col justify-between hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer text-left"
              >
                <div className="mb-4">
      ...
      <PDFModal
        ...
        pdfUrl="/how-i-work.pdf"
        title="How I Leverage AI for Rapid Prototyping"
      />
    </>
  )
}
