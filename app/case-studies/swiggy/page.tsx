...
export default function SwigyCaseStudyPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-serif text-foreground mb-4">Interested in discussing this case study?</h2>
          <p className="text-muted-foreground mb-8">I&apos;d love to walk you through the full analysis and design decisions.</p>
          <Link
            href="/#contact"
